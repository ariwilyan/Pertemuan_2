package com.example.sgmotion2.Adapter;
...
import com.example.sgmotion2.DetailMenuActivity;
import com.example.sgmotion2.Model.Makanan;
import com.example.sgmotion2.R;
...
public class ListMenuAdapter extends RecyclerView.Adapter<ListMenuAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ListMenuAdapter.MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.foodPrice.setText("Rp "+makanan.getPrice());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            cardMenu = itemView.findViewById(R.id.item_card);
        }
    }
}
